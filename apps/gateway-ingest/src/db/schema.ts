...
/**
 * Minimal parking tables for transform failures and rows that failed ingest
 * more than `MAX_PROCESS_FAILURES` times. Unpartitioned and without FKs so
 * poison payloads can still be stored, then ACK'd. SQL migration is generated
 * separately — do not apply until asked.
 */
