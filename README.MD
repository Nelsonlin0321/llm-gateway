...
| ---- | ---------------- |
| Heavy proxies and SaaS gateways on the hot path | **Ultra-lightweight** [Hono](https://hono.dev) app on [Bun](https://bun.sh) — tiny router, native HTTP, streaming pass-through |
